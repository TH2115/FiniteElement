...
myprogp: ElementCalc.o checkPositiveDef.o globalCalcp.o mainp.o matrixOp.o meshGen.o PrintMatrices.o VTKO.o
	mpicxx  -o myprogp ElementCalc.o checkPositiveDef.o globalCalcp.o mainp.o matrixOp.o meshGen.o PrintMatrices.o VTKO.o  -lboost_program_options -lblas -llapack 
