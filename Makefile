...
run:
	./myprog --a=0 --h1=1.0 --h2=1.0 --L=2.0 --t_p=0.2 --Kxx=250.0 --Kyy=250.0 --Kxy=0.0 --Nelx=10 --Nely=5 --T_BC_side='L' --T_BC=10.0 --q_BC_side='R' --q_BC=2500.0
	
	./myprog --a=0 --h1=1.0 --h2=1.0 --L=2.0 --t_p=0.2 --Kxx=250.0 --Kyy=250.0 --Kxy=0.0 --Nelx=10 --Nely=5 --T_BC_side='B' --T_BC=10.0 --q_BC_side='T' --q_BC=2500.0
	
	./myprog --a=0.25 --h1=1.0 --h2=1.3 --L=3.0 --t_p=0.2 --Kxx=250.0 --Kyy=250.0 --Kxy=0.0 --Nelx=15 --Nely=8 --T_BC_side='L' --T_BC=-20.0 --q_BC_side='B' --q_BC=-5000.0
